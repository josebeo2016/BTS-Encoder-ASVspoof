...
def genSpoof_list(dir_meta, is_train=False, is_eval=False, tts_only=False, is_dev=False):
...
class Dataset_for(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x_inp = Tensor(X_pad)
        # check directory for feats
        feat_dir = os.path.join('./feats/aug/', key.split('/')[0])
